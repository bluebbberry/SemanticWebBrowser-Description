...
\begin{table}[h]
    ...
    \hline
     & Energy-Efficient, Deterministic & IDE-Like, Language-Interface-based & Web-Paradigm-Agnostic based on ML & SemanticWeb-Support \\
    \hline
    ...
    \hline
    Web-Paradigm-Agnostic SWB & \cellcolor{yellow} Semi-Yes & \cellcolor{green}Yes & \cellcolor{green}Yes & \cellcolor{green}Yes \\
    \hline
    \end{tabular}
