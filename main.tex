...
It is largely based on the following work: \cite{semanticWebAce}. In the second part, domain discovery based on LLMs is proposed to make the browser web-paradigm agnostic.
