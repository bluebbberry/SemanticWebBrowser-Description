...
\begin{table}[h]
    ...
    \hline
     & Energy-Efficient, Deterministic & IDE-Like, Language-Interface-based & SemanticWeb-Support & Web-Paradigm-Agnostic based on ML \\
    \hline
    AceCode & Yes & Yes & No & Semi-Yes \\
    \hline
    SemanticWebBrowser (SWB) & Yes & Yes & Yes & Semi-Yes \\
    \hline
    Web-Paradigm-Agnostic SWB & Semi-Yes & Yes & Yes & Yes \\
    \hline
    \end{tabular}
...
TODO: Think about OWL - Is ACE an alternative, could it become the lingua franca of the semantic web?
...
\begin{figure}[h]
    \includegraphics[width=16cm]{Semantic-Web-technology-stack}
\end{figure}
